...
train_proto = 'example/V2_4category/MobileNetSSD_train.prototxt'
train_model = 'snapshot2/mobilenet_iter_10000.caffemodel'  #should be your snapshot caffemodel

deploy_proto = 'example/V2_4category/MobileNetSSD_deploy.prototxt'
save_model = 'example/V2_4category/MobileNetSSDV2_merged_deploy.caffemodel'
